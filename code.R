# This script is part of the "Metamodeling for Simulation-Based Optimization of Strategies in 
# Healthcare" short course presented by Hendrik Koffijberg (University of Twente, the Netherlands) 
# and Koen Degeling (Lumen Value & Access, US/Netherlands) for the Professional Society for Health 
# Economic and Outcomes Research (ISPOR). It illustrates the use of metamodels to address run time 
# issues (i.e., the # computational burden) of a health economic simulation models to enable 
# optimization.
#
